# Generated by Django 2.2.5 on 2020-01-13 06:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(blank=True, choices=[('en', 'English'), ('fr', 'French')], default='en', max_length=2, verbose_name='language')),
                ('currency', models.CharField(blank=True, choices=[('usd', 'USD'), ('euro', 'EUR')], default='usd', max_length=3)),
